        ...
        <div className="lg:flex lg:px-5">
          <div>
            <RestaurantImage
              ...
              className="lg:h-[380px] lg:w-[750px]"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-3 flex gap-4 overflow-x-scroll px-5 lg:grid lg:grid-cols-2 [&::-webkit-scrollbar]:hidden">
              {restaurant.categories.map((category) => (
                <div
                  key={category.id}
                  className="min-w-[100px] rounded-lg bg-[#F4F4F4] text-center"
                >
            ...
            <div className="hidden lg:block lg:px-5 lg:py-5">
              <h2 className="font-semibold ">Sobre</h2>
              <p className="line-clamp-5 text-sm leading-[21px] text-muted-foreground">
